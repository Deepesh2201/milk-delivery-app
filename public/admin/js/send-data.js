          ...
          //  console.log(i);            
             ...
             var myarray = [];
              $('.options').each(function(){
                ...
                var group = newval.replace("group[", "group.");
                var newgroup = group.replace("]", "");

                var batch_no = newval.replace("batch_no[", "batch_no.");
                var newbatch_no = batch_no.replace("]", "");
              
                myarray.push(myproduct); 
                myarray.push(myQty); 
                myarray.push(newprice); 
                myarray.push(newbatch_no); 
                myarray.push(newgroup);
              });
