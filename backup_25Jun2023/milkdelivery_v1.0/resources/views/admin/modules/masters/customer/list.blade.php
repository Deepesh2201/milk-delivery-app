...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="mt-0 header-title m-b-30">{{ __('l.customer') }} {{ __('l.list') }}</h4>
                ...
                <div class="table-responsive table-full-width">
                    <div style="overflow: auto;">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody id="tbody">
                                @include('admin.modules.masters.customer.tbody')
                            </tbody>
                        </table>
                    </div>
                </div>
