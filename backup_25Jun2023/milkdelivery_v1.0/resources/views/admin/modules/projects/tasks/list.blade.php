    ...
    <div class="row align-items-center">
        ...
        <a href="{{ url()->previous() }}">
                <button class="btn btn-primary arrow-none waves-effect waves-light" type="button">
                    <i class="fas fa-arrow-left"></i> @lang('l.back')</button>
            </a>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="mt-0 header-title m-b-30">{{ __('l.project_task') }} {{ __('l.list') }}</h4>
                ...
                <div class="table-responsive table-full-width">
                    <div style="overflow: auto;">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody id="tbody">
                                @include('admin.modules.projects.tasks.tbody')
                            </tbody>
                        </table>
                    </div>
                </div>
