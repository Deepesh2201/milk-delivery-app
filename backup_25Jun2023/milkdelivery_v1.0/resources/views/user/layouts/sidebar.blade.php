            ...
            <ul class="metismenu" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="submenu" aria-expanded="false">
                            ...
                            {{-- <li class="#"><a href="{{ route('product-activity.index') }}" class="waves-effect {{ Request::is('admin/product-activity/*') || Request::is('admin/product-task-list/*') ? 'mm-active': '' }}"><i class="fa fa-calendar"></i> <span>product Activity</span></a></li>--}}
                        </ul>   
                    </li>
                    <li>
                        <a href="javascript: void(0);" class="waves-effect" >                            
                        ...
                        <ul class="submenu" aria-expanded="false">
                            <li class="#"><a href="{{ route('product.index') }}" class="waves-effect {{ Request::is('admin/product/*') ? 'mm-active': '' }}"><i class="fa fa-product-hunt"></i> Products</a></li>
