...
@foreach($productArr as $p)
    <tr>
        ...
        <td>
            <!-- <div class="btn-group" role="group" aria-label="...">
                <a href="{{ route('offloading.edit',$p->onloading_id)}}" class="btn btn-default"><i class="far fa-edit"></i></a>
                <a id="{{ $p->onloading_id }}" onclick="deleteItem( this.id )" class="btn btn-default"><i class="far fa-trash-alt"></i></a>
                <a href="{{ route('offloading.delete',$p->onloading_id)}}" class="btn btn-default" ><i class="far fa-trash-alt"></i></a>
