            ...
            <div class="float-right d-md-block">
                <a href="{{ route('offloading.create')}}">
                    <button class="btn btn-primary arrow-none waves-effect waves-light" type="button">
                        <i class="fas fa-plus"></i> {{ __('l.add') }} {{ __('l.offloading')}}
                    </button>
                </a>
            </div>
        </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="mt-0 header-title m-b-30">{{ __('l.offloading') }} {{ __('l.list') }}</h4>
                @include('admin.partials.messages')
                <div class="table-responsive table-full-width">
                    <div style="overflow: auto;">
                        <form action="{{ route('offloading.search') }}" method="GET">                        
                        <!-- <div class="row"> -->
                            <div class="col-md-12">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody id="tbody">
                                @include('admin.modules.loading.off-loading.tbody')
                            </tbody>
                        </table>
                    </div>
                </div>
