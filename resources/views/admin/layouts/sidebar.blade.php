    ...
    <div class="slimscroll-menu" id="remove-scroll">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu" id="side-menu">
                    ...
                    {{-- Code written by Deepesh --}}
                    <li>
                        <a href="javascript: void(0);" class="waves-effect" >                            
                         <i class="fas fa-chart-pie" aria-hidden="true"></i> <span> Reports  <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span> </span></a>
                        </a>
                        <ul class="submenu" aria-expanded="false">
                            <li class="#"><a href="{{ route('salesreport.index') }}" class="waves-effect {{ Request::is('admin/reports/salesreport/*') ? 'mm-active': '' }}"><i class="fas fa-chart-line"  aria-hidden="true"></i> <span>Sales Report</span></a></li>
                            <li class="#"><a href="{{ route('salesreturnreport.salesreturnlist') }}" class="waves-effect {{ Request::is('admin/reports/salesreturnreport/*') ? 'mm-active': '' }}"><i class="fas fa-chart-bar"  aria-hidden="true"></i> <span>Sales Return Report</span></a></li>
                            <li class="#"><a href="{{ route('salestargetreport.salestargetlist') }}" class="waves-effect {{ Request::is('admin/reports/salestargetreport/*') ? 'mm-active': '' }}"><i class="fas fa-calendar-alt"  aria-hidden="true"></i> <span>Monthly Target Report</span></a></li>
                            <li class="#"><a href="{{ route('onloadingreport.onloadinglist') }}" class="waves-effect {{ Request::is('admin/reports/onloadingreport/*') ? 'mm-active': '' }}"><i class="fas fa-truck-loading"  aria-hidden="true"></i> <span>Onloading Report</span></a></li>
                            <li class="#"><a href="{{ route('offloadingreport.offloadinglist') }}" class="waves-effect {{ Request::is('admin/reports/offloadingreport/*') ? 'mm-active': '' }}"><i class="fas fa-truck-loading"  aria-hidden="true"></i> <span>Offloading Report</span></a></li>
                            <!-- <li class="#"><a href="{{ route('offloading.index') }}" class="waves-effect {{ Request::is('admin/offloading/*') ? 'mm-active': '' }}"><i class="fas fa-truck-unloading"  aria-hidden="true"></i> <span>Offloadings</span></a></li> -->
                        </ul>   
                    </li>
                    <li>  
