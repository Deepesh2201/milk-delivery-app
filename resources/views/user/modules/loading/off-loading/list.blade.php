...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="mt-0 header-title m-b-30">{{ __('l.product') }} {{ __('l.list') }}</h4>
                @include('user.partials.messages')
                <div class="table-responsive table-full-width">
                    <div style="overflow: auto;">
                        <form action="{{ route('user.offloading.search') }}" method="GET">                        
                        <!-- <div class="row"> -->
                            <div class="col-md-12">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody id="tbody">
                                @include('user.modules.loading.off-loading.tbody')
                            </tbody>
                        </table>
                    </div>
                </div>
