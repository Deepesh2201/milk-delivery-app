    ...
    <div class="row align-items-center">
        ...
        <div class="col-sm-6">
            <div class="float-right d-md-block">
                <a href="{{ route('user.onloading.index')}}">
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="mt-0 header-title m-b-30">@if($item) @lang('l.edit') @else @lang('l.onloadrequest') @endif
                    </h4>
                @include('admin.partials.messages')
                <form action="{{route('user.onloading.store')}}" method="POST" onsubmit="return saveOnloading(this)">
                @csrf
                    @if($onloading)
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>@lang('l.select') @lang('l.user')</label><span class="req">*</span>
                                <select class="form-control options" type="text" id="salesman" name="salesman" value="salesman" disabled>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>@lang('l.select') @lang('l.warehouse')</label><span class="req">*</span>
                                            ...
                                            <div class="p-20">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ $feature->batch_no ?? ''}}" type="text" name="batch_no[{{ $feature->product_id }}]" id="batch_no[{{ $feature->product_id }}]"
                                                        class="form-control options" placeholder="{{ __('l.batch_no') }}" value="0">
                                            ...
                                            <div class="p-20">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{$feature->qty ?? ''}}" type="number" name="qty[{{ $feature->product_id }}]" id="qty[{{ $feature->product_id }}]"
                                                        class="form-control options" placeholder="{{ __('l.quantity') }}" value="0">
