        ...
        <td>{{ $item->created_at ?? '' }}</td>
                ...
                <td>
                    <div class="btn-group" role="group" aria-label="...">
                        <a href="{{ route('user.onloading.edit', $item->id) }}"><button type="button"
                                class="btn-success"><span
                                    class=""style="backgroudn-color:red;color:white">Update</span></a>
                ...
                <td>
                    <div class="btn-group" role="group" aria-label="...">
                        <button type="button" value="{{$item->id}}"
                            {{-- <a href="{{ route('user.onloading.startonloading', $item->id) }}"><button type="button" --}}
                                class="btn-primary startloadingbtn" onclick="onloaddata({{$item->id}});"><span
                                    class=""style="backgroudn-color:red;color:white" >Start Loading</span>
                        <!-- <a id="{{ $item->id }}" onclick="deleteItem( this.id )" class="btn btn-default"><i class="far fa-trash-alt"></i></a> -->
                        {{-- <a href="{{ route('onloading.delete',$item->id)}}" class="btn btn-default" ><i class="far fa-trash-alt"></i></a> --}}
