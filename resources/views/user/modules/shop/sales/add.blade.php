    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{route('sale.store')}}" method="POST" onsubmit="return saveOnloading(this)">
                @csrf
                    @if($sale)
                    ...
                    <div id="dynamic_field">                   
                                ...
                                <div id="row{{$loop->iteration}}" class="row dynamic-added"> 
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control options" type="text" name="product[{{ $feature->product_id }}]" value="{{ strtoupper($feature->soldProducts->name) }}" readonly>
                                    ...
                                    <div class="col-md-2">
                                        <div class="p-20">
                                            <div class="form-group">
                                                ...
                                                <input value="{{ $feature->soldProducts->group ?? ''}}" type="text" name="group[{{ $feature->product_id }}]" id="group[{{ $feature->product_id }}]"
                        ...
                        @else       
                            @if(OnloadedProducts())
                            @foreach(OnloadedProducts(['productlist']) as $product)                  
                            <div class="row"> 
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>@lang('l.product')</label><span class="req">*</span>
                                ...
                                <div class="col-md-1">
                                    <div class="p-20">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ strtoupper($product->qty) ?? '' }}" type="text" name="availqty[{{ $product->id }}]" id="availqty[{{ $product->id }}]"
                                                class="form-control options" placeholder="{{ __('l.group') }}" readonly>
                                            <div class="group_{{ $product->id }} help-block"></div>
                                        </div>
                                    </div>
