            ...
            <ul class="metismenu" id="side-menu">
                    ...
                    <!-- <li>
                        ...
                        <ul class="submenu" aria-expanded="false"> -->
                            <li class="#"><a href="{{ route('sale.index') }}" class="waves-effect {{ Request::is('salesman/sale/*') ? 'mm-active': '' }}"><i class="fas fa-shopping-bag"></i> <span>Sales</span></a></li>
                            <li class="#"><a href="{{ route('return-product.index') }}" class="waves-effect {{ Request::is('salesman/return-product/*') ? 'mm-active': '' }}"><i class="fas fa-money-check"></i> <span>Return</span></a></li>
                        <!-- </ul>   
                    </li> -->
                    <!-- <li>
                        <a href="javascript: void(0);" class="waves-effect" >                            
                        ...
                        <ul class="submenu" aria-expanded="false"> -->
                            <li class="#"><a href="{{ route('user.onloading.index') }}" class="waves-effect {{ Request::is('salesman/onloading/*') ? 'mm-active': '' }}"><i class="fas fa-truck-loading"  aria-hidden="true"></i> <span>Onloadings</span></a></li>
                            <li class="#"><a href="{{ route('user.offloading.index') }}" class="waves-effect {{ Request::is('salesman/ven-status/*') ? 'mm-active': '' }}"><i class="fas fa-truck"  aria-hidden="true"></i> <span>Ven Status</span></a></li>
                        <!-- </ul>   
                    </li> -->
