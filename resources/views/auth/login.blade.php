...
<div class="wrapper-page">
    <div class="card overflow-hidden account-card mx-3">
        <div class="bg-primary p-4 text-white text-center position-relative">
            ...
            <p class="text-white-50 mb-4" style="color:rgb(255, 255, 255) !important;">Sign in to continue to MilkDelivery.</p>
            <a href="{{ URL::to('/') }}" class="logo logo-admin"><img
                    src="{{ URL::asset('public/admin/images/logo-placeholder-image.png') }}" height="38" alt="logo"></a>
        </div>
